...
const products = [
    ...
    { id: 5, category: 'reg', name: '[Acc Reg] Reg Nak Vệ Thần', price: 1400000, description: 'Acc Reg sạch sẽ, đã xác minh, sẵn sàng giao dịch.', image: 'https://shoptethan.com/files/28/images/2023-05-25/nes1-Wn.webp', details: 'Loại: Acc Reg\nTình trạng: Sạch sẽ\nĐã xác minh' },
