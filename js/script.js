...
const products = [
    ...
    { id: 5, category: 'reg', name: '[Acc Reg] Acc Reg chất lượng', price: 1400000, description: 'Acc Reg sạch sẽ, đã xác minh, sẵn sàng giao dịch.', image: 'https://shoptethan.com/files/28/images/2023-05-25/nes1-Wn.webp', details: 'Loại: Acc Reg\nTình trạng: Sạch sẽ\nĐã xác minh' },
    { id: 6, category: 'gia-re', name: '[Acc Giá Rẻ] Acc Rank Bạc', price: 90000, description: 'Acc giá rẻ, Rank Bạc, dành cho người mới.', image: 'https://picsum.photos/seed/lq5/600/400', details: 'Rank: Bạc\nGiá tốt cho người mới' },
    { id: 7, category: 'vip', name: '[VIP] Acc Full Tướng 60+ Skin Hiếm', price: 2500000, description: 'Acc VIP full tướng 60+, nhiều skin hiếm, rank cao chuyên leo.', image: 'https://picsum.photos/seed/lqvip1/600/400', details: 'Rank: Cao Thủ/Quán Quân\nTướng: full 60+\nSkin hiếm: nhiều' },
    { id: 8, category: 'vip', name: '[VIP] Acc Siêu Xịn Full Tướng & Skin', price: 3200000, description: 'Acc siêu VIP, full tướng, skin limited và nhiều tướng meta.', image: 'https://picsum.photos/seed/lqvip2/600/400', details: 'Rank: Quán Quân/Chiến Tướng\nTướng: full\nSkin: hạn chế' }
];
